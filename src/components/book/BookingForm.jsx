            ...
            <div style={{ marginBottom: 10 }}>
              ...
              {estimate && (
                <div style={{ marginTop:8 }}>
                  {/* If backend returns a simple number, show it; if an object, pretty-print */}
                  {typeof estimate === "number" || typeof estimate === "string" ? (
                    <div>Estimated fee: <strong>₹ {estimate}</strong></div>
                  ) : (
                    <div>
                      <div style={{ fontSize: 13, color: "#374151" }}>Breakdown:</div>
                      <pre style={{ marginTop: 8 }}>{JSON.stringify(estimate, null, 2)}</pre>
                    </div>
                  )}
                </div>
              )}
